...
Each node of the tree will have a root value and
a list of references to other nodes which are called child nodes.
...
As the name suggests, a binary tree is a tree data structure in which each node has at most two children,
